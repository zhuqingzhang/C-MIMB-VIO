...
namespace ov_msckf {
    ...
    protected:
        ...
        // Our publishers
        ros::Publisher pub_poseimu,pub_poseimu_rect,pub_transform, pub_odomimu, pub_pathimu, pub_pathimu_rect, pub_local_relative_transform;
        ...
        ros::Publisher pub_transform_1, pub_transform_2, pub_transform_3, pub_transform_4;
        ros::Publisher pub_match_keyframe_location_seq1,pub_match_keyframe_location_seq2,pub_match_keyframe_location_seq3,pub_match_keyframe_location_seq4;
        tf::TransformBroadcaster *mTfBr;
        ros::Publisher pub_mappath_1,pub_mappath_2,pub_mappath_3,pub_mappath_4;
        unsigned int pose_seq_map1=0;
        unsigned int pose_seq_map2=0;
        unsigned int pose_seq_map3=0;
        unsigned int pose_seq_map4=0;
        ...
        map<int,vector<Eigen::Vector3d>> maps_keyframe_positions_in_local;
