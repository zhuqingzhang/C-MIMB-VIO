...
namespace ov_msckf {
    ...
    struct VioManagerOptions {
        ...
        ///added by zzq
        std::string map_save_path ="/home/zzq/";
        ...
        std::vector<std::string> pose_graph_filenames;

        std::vector<std::string> keyframe_pose_filenames;

        bool use_multi_map = true;
