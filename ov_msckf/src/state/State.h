...
namespace ov_msckf {
    ...
    public:
        ...
        std::map<int,vector<Keyframe*>> _seq_Keyframes;

        PoseJPL* transform_vio_to_map;

        std::map<int,PoseJPL*> transform_vio_to_maps;

        std::map<int,bool> set_transforms;
        ...
        vector<ofstream> of_keyframe_positions;
        ...
        Keyframe* destination_kf=nullptr;
